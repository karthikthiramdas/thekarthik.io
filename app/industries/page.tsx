    ...
    <main id="main-content">
      ...
      <section className="bg-paper section-y">
        <div className="container-page">
          ...
          <Statement
            lines={[industries.categoriesIntro]}
            className="mt-8"
          />
          ...
          <div className="mt-14 grid md:grid-cols-2 gap-x-12 gap-y-14">
            {industries.categories.map((cat) => (
              ...
              >
                ...
                <p className="mt-5 text-ink/45 text-sm leading-relaxed">
                  {cat.items.join(" · ")}
                </p>
      ...
      <section className="bg-paper-dim section-y">
        <div className="container-page">
          <Folio
            index="02"
            label={industries.completedWork.label}
          />

          <Statement
            lines={industries.completedWork.headline}
            className="mt-8"
          />
          ...
          <div className="mt-6 flex flex-wrap items-end justify-between gap-6 max-w-2xl">
            ...
            <a
              href={sitePath(industries.completedWork.href)}
          ...
          <div className="mt-10 grid md:grid-cols-3 gap-6">
            <Frame
              label="Aviation"
              caption="Wing Study, Golden Hour"
              tone="brass"
              ratio="square"
            ...
            <Frame
              label="Aviation"
              caption="Tarmac, Ladakh"
              tone="brass"
              ratio="square"
              src="/thekarthik.io/images/real/tarmac-aircraft.jpeg"
            />
            ...
            <Frame
              ...
              tone="brass"
              ratio="square"
              src="/thekarthik.io/images/real/cabin-tray.jpeg"
            />
          </div>
        </div>
      </section>
      ...
      <section className="bg-paper section-y">
        <div className="container-page">
          ...
          <Statement
            lines={[industries.collaborationsIntro]}
            className="mt-8"
          />
          ...
          <div className="mt-14 grid md:grid-cols-2 gap-10">
            {industries.collaborations.map((collab) => (
              ...
              >
                ...
                <div className="mt-6">
                  <span className="field-label text-oxblood">
                    {collab.category}
                  </span>
      ...
      <section className="bg-paper-dim section-y">
        <div className="container-page max-w-2xl">
          <Folio
            index="04"
            label={industries.openCategories.label}
          />

          <Statement
            lines={industries.openCategories.headline}
            emphasisIndex={0}
            className="mt-8"
          />

          <p className="mt-6 text-ink/60 leading-relaxed">
            {industries.openCategories.intro}
          </p>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            {industries.openCategories.names.map((name) => (
              ...
              >
                ...
                <span className="field-label text-ink/60">
                  {name}
                </span>
              </span>
            ))}
